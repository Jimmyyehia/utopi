...
export function HomePageClient({ initialData }: HomePageClientProps) {
  ...
  // Instant data initialization directly from server
  ...
  const handleBookingSubmit = async (data: {
    ...
    if (!res.ok) {
      ...
      setNotification({
        ...
        message: errorData.error || "Room is already booked for this time slot.",
        type: "error",
      })
      return
    }
    ...
    const isApproved = newBooking.status === "APPROVED" || isManager
    setNotification({
      isOpen: true,
      title: isApproved ? "Reservation Confirmed! 🎉" : "Request Submitted for Review 🚀",
      message: isApproved
        ? "🎉 Your room reservation is confirmed! The space has been automatically approved and reserved for your role."
        : "🎉 Your reservation request has been submitted! Workspace managers will review it shortly.",
      type: "success",
    })
  }
